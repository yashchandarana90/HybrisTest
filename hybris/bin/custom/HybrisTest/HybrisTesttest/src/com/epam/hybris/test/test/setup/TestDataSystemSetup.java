 ...
 *
 */
package com.epam.hybris.test.test.setup;
...
import com.epam.hybris.test.test.constants.HybrisTestTestConstants;
import com.epam.hybris.test.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HybrisTestTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/HybrisTesttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/HybrisTesttest/import/reviews.impex");
			...
			importImpexFile(context, "/HybrisTesttest/import/cstickets.impex");
		}
	}
}
