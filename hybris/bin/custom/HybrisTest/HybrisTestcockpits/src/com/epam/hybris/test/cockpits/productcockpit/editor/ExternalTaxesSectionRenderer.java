 ...
 *
 */
package com.epam.hybris.test.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("HybrisTestcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("HybrisTestcockpits.product.externalTaxes"));
