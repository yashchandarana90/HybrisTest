 ...
 *
 */
package com.epam.hybris.test.cockpits.setup;
...
import com.epam.hybris.test.cockpits.constants.HybrisTestCockpitsConstants;
 ...
 */
@SystemSetup(extension = HybrisTestCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(HybrisTestCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(HybrisTestCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						HybrisTestCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/HybrisTestcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
