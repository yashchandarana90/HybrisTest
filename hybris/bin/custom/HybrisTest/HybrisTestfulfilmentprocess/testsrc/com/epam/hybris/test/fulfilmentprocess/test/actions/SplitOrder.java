 ...
 *
 */
package com.epam.hybris.test.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(HybrisTestFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HybrisTestFulfilmentProcessConstants.PARENT_PROCESS);
