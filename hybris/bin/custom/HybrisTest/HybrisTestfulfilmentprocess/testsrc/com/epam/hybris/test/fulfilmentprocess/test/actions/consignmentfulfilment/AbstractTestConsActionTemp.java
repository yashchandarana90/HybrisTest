 ...
 *
 */
package com.epam.hybris.test.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, HybrisTestFulfilmentProcessConstants.PARENT_PROCESS);
