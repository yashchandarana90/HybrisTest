 ...
 *
 */
package com.epam.hybris.test.fulfilmentprocess.test.jobs;
...
import com.epam.hybris.test.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = HybrisTestFulfilmentProcessConstants.ORDER_PROCESS_NAME;
