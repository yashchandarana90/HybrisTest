 ...
 *
 */
package com.epam.hybris.test.core.hmc;
...
/**
 * Provides necessary meta information about the HybrisTestcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class HybrisTestCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(HybrisTestCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.epam.hybris.test.core.hmc.locales";
