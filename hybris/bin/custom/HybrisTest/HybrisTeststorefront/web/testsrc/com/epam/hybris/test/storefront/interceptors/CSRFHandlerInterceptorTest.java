 ...
 *
 */
package com.epam.hybris.test.storefront.interceptors;
...
import com.epam.hybris.test.storefront.util.CSRFHandlerInterceptor;
import com.epam.hybris.test.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "com.epam.hybris.test.storefront.util.CSRFTokenManager.tokenval";
